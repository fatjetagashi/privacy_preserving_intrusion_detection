        ...
        rows.append(
            {
                ...
                "prediction_level": run_config.get("prediction_level"),
                "pooling": run_config.get("pooling"),
                "solver": run_config.get("solver"),
                "time_conditioning": run_config.get("time_conditioning"),
                "x_embed_dim": run_config.get("x_embed_dim"),
                "hidden_dim": run_config.get("hidden_dim"),
                "ode_hidden": run_config.get("ode_hidden"),
                "ode_layers": run_config.get("ode_layers"),
                "ode_steps": run_config.get("ode_steps"),
                "dropout": run_config.get("dropout"),
                "lr": run_config.get("lr"),
                "weight_decay": run_config.get("weight_decay"),
                "dt_clip": run_config.get("dt_clip"),
